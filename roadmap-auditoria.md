...
| 2026-09-09 | FIX-sesión-real | Auth QML sin env (módulo `qml.auth` generado + fallback, `-I` con precedencia), título sin overflow (Item acotado+clip, Row legal), fail-fast si puerto ocupado, `QML_DISABLE_DISK_CACHE`, diagnósticos 401/0, indicador ▾ en modelos | 72 passed, QML OK, auth live 401/200 | pendiente |
